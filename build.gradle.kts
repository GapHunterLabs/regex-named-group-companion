...
dependencies {
    ...
    intellijPlatform {
        ...
        // Named-group detection over Java/Kotlin regex literals needs
        // real PSI for both languages -- same two bundled plugins
        // highlight-companion already depends on for its Java/Kotlin
        // cognitive-complexity walkers.
